...
public class AssetRecordDaoHibernate extends AbstractDaoHibernate<OnmsAssetRecord, Integer> implements AssetRecordDao {
    ...
    public Map<String, Integer> findImportedAssetNumbersToNodeIds(String foreignSource) {
        ...
        @SuppressWarnings("unchecked") List<Object[]> assetNumbers = (List<Object[]>)hibernateTemplate.find("select a.node.id, a.assetNumber from OnmsAssetRecord a where a.assetNumber like '" + foreignSource + "%'");
    ...
    public List<OnmsAssetRecord> getDistinctProperties() {
        ...
        List<OnmsAssetRecord> result = (List<OnmsAssetRecord>)hibernateTemplate.findByCriteria(criteria);
        return result;
    }
}
